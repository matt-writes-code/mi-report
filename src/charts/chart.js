...
import ReactFC from "react-fusioncharts";
import dataFetch from "../data/dataFetch.json";
import schemaFetch from "../data/schemaFetch.json";
...
class ColumnChartTimeAxis extends Component {
  ...
  render() {
    return (
      <div>
        <ReactFC {...this.state.timeseriesDs} className="charts" />
      </div>
    );
  }
}
